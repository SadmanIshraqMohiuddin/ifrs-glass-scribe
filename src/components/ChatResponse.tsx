...
export function ChatResponse({ messages, isLoading }: ChatResponseProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {isLoading && (
        <div className="flex justify-start">
          <div className="glass border rounded-2xl rounded-tl-md p-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-muted-foreground">IFRS Advisor is analyzing...</span>
            </div>
          </div>
        </div>
      )}
      ...
      {summary && (
        <div className="glass border rounded-2xl p-6">
          ...
          >
            <h3 className="text-lg font-semibold text-primary">Summary of Findings</h3>
            {summaryExpanded ? (
